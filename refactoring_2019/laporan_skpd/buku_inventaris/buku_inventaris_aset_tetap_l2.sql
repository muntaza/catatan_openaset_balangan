DROP VIEW IF EXISTS view_buku_inventaris_aset_tetap_l2 CASCADE;


CREATE VIEW view_buku_inventaris_aset_tetap_l2 AS
...
GRANT ALL PRIVILEGES ON view_buku_inventaris_aset_tetap_l2 TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_buku_inventaris_aset_tetap_l2 FROM lap_kabupaten;
