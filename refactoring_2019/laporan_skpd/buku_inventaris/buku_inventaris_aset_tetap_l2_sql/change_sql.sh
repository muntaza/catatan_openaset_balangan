...
file_awal=buku_inventaris_aset_tetap_l2.sh
file_akhir=buku_inventaris_aset_tetap_l2_2017.sh

cat $file_awal  | sed -e s/Dispu/DPUPR/g | sed -e s/dispu/dpupr/g \
	| sed -e s/KPDAD/Perpustakaan/g | sed -e s/kpdad/perpustakaan/g \
        ...
        | sed -e s/B48/BPPD/g | sed -e s/b48/bppd/g > $file_akhir
