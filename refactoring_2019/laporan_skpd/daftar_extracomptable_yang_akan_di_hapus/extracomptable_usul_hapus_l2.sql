DROP VIEW IF EXISTS view_extracomptable_usul_hapus_l2 CASCADE;


CREATE VIEW view_extracomptable_usul_hapus_l2 AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_usul_hapus_l2 TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_usul_hapus_l2 FROM lap_kabupaten;
