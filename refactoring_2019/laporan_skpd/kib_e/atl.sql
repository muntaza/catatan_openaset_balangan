DROP VIEW IF EXISTS view_atl_kabupaten;


CREATE VIEW view_atl_kabupaten AS
...
GRANT ALL PRIVILEGES ON view_atl_kabupaten TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_atl_kabupaten FROM lap_kabupaten;
