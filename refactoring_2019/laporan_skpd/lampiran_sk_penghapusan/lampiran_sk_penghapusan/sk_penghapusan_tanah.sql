...
GRANT ALL PRIVILEGES ON view_sk_penghapusan_tanah_kabupaten TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_sk_penghapusan_tanah_kabupaten FROM lap_kabupaten;
