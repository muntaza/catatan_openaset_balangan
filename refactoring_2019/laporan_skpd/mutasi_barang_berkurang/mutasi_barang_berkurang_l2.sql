DROP VIEW IF EXISTS view_mutasi_barang_berkurang_l2 CASCADE;


CREATE VIEW view_mutasi_barang_berkurang_l2 AS
...
GRANT ALL PRIVILEGES ON view_mutasi_barang_berkurang_l2 TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_mutasi_barang_berkurang_l2 FROM lap_kabupaten;
