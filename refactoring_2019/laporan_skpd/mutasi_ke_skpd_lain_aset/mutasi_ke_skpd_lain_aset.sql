DROP VIEW IF EXISTS view_mutasi_ke_skpd_lain_aset CASCADE;


CREATE VIEW view_mutasi_ke_skpd_lain_aset AS
...
tahun_berkurang_tanah.tahun_berkurang,
skpd_tujuan_tanah.id_skpd as id_skpd_tujuan,
tanah.keterangan
...
hak_tanah, sub_skpd, skpd, lokasi_bidang, kabupaten, provinsi, tahun_berkurang_tanah,
skpd_tujuan_tanah
...
tanah.id = skpd_tujuan_tanah.id_tanah AND
...
tahun_berkurang_peralatan_mesin.tahun_berkurang,
skpd_tujuan_peralatan_mesin.id_skpd as id_skpd_tujuan,
...
mutasi_berkurang, asal_usul, keadaan_barang, satuan_barang, golongan_barang,
sub_skpd, skpd, lokasi_bidang, kabupaten, provinsi, tahun_berkurang_peralatan_mesin,
skpd_tujuan_peralatan_mesin


WHERE
1 = 1  AND
peralatan_mesin.id = tahun_berkurang_peralatan_mesin.id_peralatan_mesin AND
peralatan_mesin.id = skpd_tujuan_peralatan_mesin.id_peralatan_mesin AND
...
tahun_berkurang_gedung_bangunan.tahun_berkurang,
skpd_tujuan_gedung_bangunan.id_skpd as id_skpd_tujuan,
...
sub_skpd, skpd, lokasi_bidang, kabupaten, provinsi, view_tanah_tanpa_harga_kabupaten, tahun_berkurang_gedung_bangunan,
skpd_tujuan_gedung_bangunan


WHERE
1 = 1  AND
gedung_bangunan.id = tahun_berkurang_gedung_bangunan.id_gedung_bangunan AND
gedung_bangunan.id = skpd_tujuan_gedung_bangunan.id_gedung_bangunan AND
...
tahun_berkurang_jij.tahun_berkurang,
skpd_tujuan_jalan_irigasi_jaringan.id_skpd as id_skpd_tujuan,
...
mutasi_berkurang, asal_usul, keadaan_barang, satuan_barang, golongan_barang,
sub_skpd, skpd, lokasi_bidang, kabupaten, provinsi, view_tanah_tanpa_harga_kabupaten, tahun_berkurang_jij,
skpd_tujuan_jalan_irigasi_jaringan


WHERE
1 = 1  AND
jalan_irigasi_jaringan.id = tahun_berkurang_jij.id_jalan_irigasi_jaringan AND
jalan_irigasi_jaringan.id = skpd_tujuan_jalan_irigasi_jaringan.id_jalan_irigasi_jaringan AND
...
tahun_berkurang_atl.tahun_berkurang,
skpd_tujuan_atl.id_skpd as id_skpd_tujuan,
atl.keterangan
...
mutasi_berkurang, asal_usul, keadaan_barang, satuan_barang, golongan_barang,
sub_skpd, skpd, lokasi_bidang, kabupaten, provinsi, tahun_berkurang_atl,
skpd_tujuan_atl
...
atl.id = skpd_tujuan_atl.id_atl AND
...
GRANT ALL PRIVILEGES ON view_mutasi_ke_skpd_lain_aset TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_mutasi_ke_skpd_lain_aset FROM lap_kabupaten;
...
GRANT ALL PRIVILEGES ON mutasi_berkurang, keadaan_barang TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON mutasi_berkurang, keadaan_barang FROM lap_kabupaten;
