DROP VIEW IF EXISTS view_mutasi_ke_skpd_lain_extracomptable CASCADE;


CREATE VIEW view_mutasi_ke_skpd_lain_extracomptable AS
...
GRANT ALL PRIVILEGES ON view_mutasi_ke_skpd_lain_extracomptable TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_mutasi_ke_skpd_lain_extracomptable FROM lap_kabupaten;
