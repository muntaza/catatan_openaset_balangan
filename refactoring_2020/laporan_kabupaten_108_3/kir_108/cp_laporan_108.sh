...
cat /var/www/html/php5_laporan/php5_projects/kabupaten/kir.xml  | \
...
cat /var/www/html/php5_laporan/php5_projects/01_setwan/kir.xml  | \
	sed -e s/kode_barang/kode_barang_108/g | \
	sed -e s/view_kir_setwan/view_kir_108_setwan/g | \
	sed -e s/kode_level_2/kode_level_2_108/g  \
