DROP VIEW IF EXISTS view_kir_108_kabupaten CASCADE;


CREATE VIEW view_kir_108_kabupaten AS
...
GRANT ALL PRIVILEGES ON view_kir_108_kabupaten TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_kir_108_kabupaten FROM lap_kabupaten;
