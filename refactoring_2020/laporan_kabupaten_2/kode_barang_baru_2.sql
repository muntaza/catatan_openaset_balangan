-- kode barang baru
CREATE OR REPLACE VIEW view_extracomptable_108_kabupaten AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_kabupaten TO lap_kabupaten;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_kabupaten FROM lap_kabupaten;
...
CREATE OR REPLACE VIEW view_extracomptable_108_awayan AS

SELECT
*

FROM
view_extracomptable_108_kabupaten

WHERE
1 = 1  AND
id_skpd = 34;

GRANT ALL PRIVILEGES ON view_extracomptable_108_awayan TO lap_awayan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_awayan FROM lap_awayan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_bappeda AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_bappeda TO lap_bappeda;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_bappeda FROM lap_bappeda;
...
CREATE OR REPLACE VIEW view_extracomptable_108_batumandi AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_batumandi TO lap_batumandi;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_batumandi FROM lap_batumandi;
...
CREATE OR REPLACE VIEW view_extracomptable_108_batupiring AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_batupiring TO lap_batupiring;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_batupiring FROM lap_batupiring;
...
CREATE OR REPLACE VIEW view_extracomptable_108_bkd AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_bkd TO lap_bkd;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_bkd FROM lap_bkd;
...
CREATE OR REPLACE VIEW view_extracomptable_108_bkppd AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_bkppd TO lap_bkppd;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_bkppd FROM lap_bkppd;
...
CREATE OR REPLACE VIEW view_extracomptable_108_bpbd AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_bpbd TO lap_bpbd;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_bpbd FROM lap_bpbd;
...
CREATE OR REPLACE VIEW view_extracomptable_108_bppd AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_bppd TO lap_bppd;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_bppd FROM lap_bppd;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dinkes AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dinkes TO lap_dinkes;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dinkes FROM lap_dinkes;
...
CREATE OR REPLACE VIEW view_extracomptable_108_disdik AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_disdik TO lap_disdik;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_disdik FROM lap_disdik;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dishub AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dishub TO lap_dishub;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dishub FROM lap_dishub;
...
CREATE OR REPLACE VIEW view_extracomptable_108_disnakertrans AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_disnakertrans TO lap_disnakertrans;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_disnakertrans FROM lap_disnakertrans;
...
CREATE OR REPLACE VIEW view_extracomptable_108_distamben AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_distamben TO lap_distamben;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_distamben FROM lap_distamben;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dko AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dko TO lap_dko;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dko FROM lap_dko;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dkp AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dkp TO lap_dkp;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dkp FROM lap_dkp;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dkukmp AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dkukmp TO lap_dkukmp;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dkukmp FROM lap_dkukmp;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dlh AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dlh TO lap_dlh;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dlh FROM lap_dlh;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dpkp AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dpkp TO lap_dpkp;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dpkp FROM lap_dpkp;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dpmd AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dpmd TO lap_dpmd;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dpmd FROM lap_dpmd;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dpmptsp AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dpmptsp TO lap_dpmptsp;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dpmptsp FROM lap_dpmptsp;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dppkb AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dppkb TO lap_dppkb;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dppkb FROM lap_dppkb;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dpppa AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dpppa TO lap_dpppa;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dpppa FROM lap_dpppa;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dpupr AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dpupr TO lap_dpupr;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dpupr FROM lap_dpupr;
...
CREATE OR REPLACE VIEW view_extracomptable_108_dukcatpil AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_dukcatpil TO lap_dukcatpil;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_dukcatpil FROM lap_dukcatpil;
...
CREATE OR REPLACE VIEW view_extracomptable_108_halong AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_halong TO lap_halong;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_halong FROM lap_halong;
...
CREATE OR REPLACE VIEW view_extracomptable_108_inspektorat AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_inspektorat TO lap_inspektorat;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_inspektorat FROM lap_inspektorat;
...
CREATE OR REPLACE VIEW view_extracomptable_108_juai AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_juai TO lap_juai;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_juai FROM lap_juai;
...
CREATE OR REPLACE VIEW view_extracomptable_108_kearsipan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_kearsipan TO lap_kearsipan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_kearsipan FROM lap_kearsipan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_kehutanan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_kehutanan TO lap_kehutanan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_kehutanan FROM lap_kehutanan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_kesbangpol AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_kesbangpol TO lap_kesbangpol;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_kesbangpol FROM lap_kesbangpol;
...
CREATE OR REPLACE VIEW view_extracomptable_108_kominfo AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_kominfo TO lap_kominfo;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_kominfo FROM lap_kominfo;
...
CREATE OR REPLACE VIEW view_extracomptable_108_korpri AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_korpri TO lap_korpri;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_korpri FROM lap_korpri;
...
CREATE OR REPLACE VIEW view_extracomptable_108_lampihong AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_lampihong TO lap_lampihong;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_lampihong FROM lap_lampihong;
...
CREATE OR REPLACE VIEW view_extracomptable_108_paringin AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_paringin TO lap_paringin;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_paringin FROM lap_paringin;
...
CREATE OR REPLACE VIEW view_extracomptable_108_paringinkota AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_paringinkota TO lap_paringinkota;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_paringinkota FROM lap_paringinkota;
...
CREATE OR REPLACE VIEW view_extracomptable_108_paringinselatan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_paringinselatan TO lap_paringinselatan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_paringinselatan FROM lap_paringinselatan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_paringintimur AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_paringintimur TO lap_paringintimur;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_paringintimur FROM lap_paringintimur;
...
CREATE OR REPLACE VIEW view_extracomptable_108_pariwisata AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_pariwisata TO lap_pariwisata;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_pariwisata FROM lap_pariwisata;
...
CREATE OR REPLACE VIEW view_extracomptable_108_perdagangan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_perdagangan TO lap_perdagangan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_perdagangan FROM lap_perdagangan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_perikanan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_perikanan TO lap_perikanan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_perikanan FROM lap_perikanan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_perpustakaan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_perpustakaan TO lap_perpustakaan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_perpustakaan FROM lap_perpustakaan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_pertanian AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_pertanian TO lap_pertanian;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_pertanian FROM lap_pertanian;
...
CREATE OR REPLACE VIEW view_extracomptable_108_rsud AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_rsud TO lap_rsud;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_rsud FROM lap_rsud;
...
CREATE OR REPLACE VIEW view_extracomptable_108_satpolpp AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_satpolpp TO lap_satpolpp;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_satpolpp FROM lap_satpolpp;
...
CREATE OR REPLACE VIEW view_extracomptable_108_setda AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_setda TO lap_setda;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_setda FROM lap_setda;
...
CREATE OR REPLACE VIEW view_extracomptable_108_setwan AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_setwan TO lap_setwan;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_setwan FROM lap_setwan;
...
CREATE OR REPLACE VIEW view_extracomptable_108_sosial AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_sosial TO lap_sosial;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_sosial FROM lap_sosial;
...
CREATE OR REPLACE VIEW view_extracomptable_108_tebingtinggi AS
...
GRANT ALL PRIVILEGES ON view_extracomptable_108_tebingtinggi TO lap_tebingtinggi;
REVOKE INSERT, UPDATE, DELETE ON view_extracomptable_108_tebingtinggi FROM lap_tebingtinggi;
